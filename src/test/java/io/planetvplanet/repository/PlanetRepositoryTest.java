...
class PlanetRepositoryTest {
  @Autowired private PlanetRepository underTest;
  ...
  void findByPlanetNameIgnoreCaseContaining_onEmptyRepository_returnsEmptyCollection() {
    ...
    // When
    Collection<Planet> planetCollection = underTest.search(inputName, false, Pageable.unpaged());
  ...
  void findByExoplanetFlag_onEmptyRepository_returnsEmptyPage() {
    // When
    Page<Planet> planetPage = underTest.findByIsExoplanet(false, Pageable.unpaged());
  ...
  void findByExoplanetFlag_onInvalidPageIndex_returnsEmptyPage() {
    ...
    // When
    Page<Planet> planetPage =
        underTest.findByIsExoplanet(false, PageRequest.of(invalidPageIdx, pageSize));
