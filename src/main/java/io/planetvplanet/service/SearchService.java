...
public class SearchService implements ISearchService {
    ...
    @Override
    public Collection<SearchPlanetResult> getPlanetsByNameSubstring(String input, boolean isExoplanet) {
        ...
        if(input.length() >= 2) {
            ...
            for(Planet planet : planetRepository.search(input, isExoplanet, PageRequest.ofSize(limitSize))) {
